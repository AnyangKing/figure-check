...
if __name__ == '__main__':
    ...
    # Figure 4-6: 분석 그래프 (TDOA 단위 초 변환 및 x축 레이블 맞춤 마커)
    tdoa_steps_sec = tdoa_steps / 150000.0
    # 마커 간격: 거리(100m 단위=10스텝), TDOA(1e-5s 단위=15스텝), DOA(0.2deg 단위=2스텝)
    configs = [
        (4, dist_steps/100.0, res_dist, "Distance (m)", "거리별 오차", 10),
        (5, tdoa_steps_sec, res_tdoa, "TDOA Error (s)", "TDOA 노이즈별 오차", 15),
        (6, doa_steps, res_doa, "DOA Error (deg)", "DOA 노이즈별 오차", 2)
    ]
